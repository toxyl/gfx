...
func TestFilters(t *testing.T) {
	...
	tests := []struct {
		...
		{"contrast-0.75", filters.CONTRAST, map[string]any{"amount": 0.75}},
		{"contrast-1.00", filters.CONTRAST, map[string]any{"amount": 1.00}},
		{"contrast-1.25", filters.CONTRAST, map[string]any{"amount": 1.25}},
		{"contrast-1.50", filters.CONTRAST, map[string]any{"amount": 1.50}},
		{"contrast-2.00", filters.CONTRAST, map[string]any{"amount": 2.00}},
		{"contrast-4.00", filters.CONTRAST, map[string]any{"amount": 4.00}},
		{"contrast-8.00", filters.CONTRAST, map[string]any{"amount": 8.00}},
		{"contrast-16.00", filters.CONTRAST, map[string]any{"amount": 16.00}},
		{"contrast-32.00", filters.CONTRAST, map[string]any{"amount": 32.00}},
		{"contrast-64.00", filters.CONTRAST, map[string]any{"amount": 64.00}},
		{"contrast-128.00", filters.CONTRAST, map[string]any{"amount": 128.00}},
		...
		{"hue-contrast--1.00", filters.HUE_CONTRAST, map[string]any{"amount": -1.00}},
		{"hue-contrast--0.75", filters.HUE_CONTRAST, map[string]any{"amount": -0.75}},
		{"hue-contrast--0.50", filters.HUE_CONTRAST, map[string]any{"amount": -0.50}},
		{"hue-contrast--0.25", filters.HUE_CONTRAST, map[string]any{"amount": -0.25}},
		{"hue-contrast-0.00", filters.HUE_CONTRAST, map[string]any{"amount": 0.00}},
		{"hue-contrast-0.25", filters.HUE_CONTRAST, map[string]any{"amount": 0.25}},
		{"hue-contrast-0.50", filters.HUE_CONTRAST, map[string]any{"amount": 0.50}},
		{"hue-contrast-0.75", filters.HUE_CONTRAST, map[string]any{"amount": 0.75}},
		{"hue-contrast-1.00", filters.HUE_CONTRAST, map[string]any{"amount": 1.00}},
		{"hue-contrast-1.50", filters.HUE_CONTRAST, map[string]any{"amount": 1.50}},
		{"hue-contrast-2.00", filters.HUE_CONTRAST, map[string]any{"amount": 2.00}},

		{"sat-contrast--1.00", filters.SAT_CONTRAST, map[string]any{"amount": -1.00}},
		{"sat-contrast--0.75", filters.SAT_CONTRAST, map[string]any{"amount": -0.75}},
		{"sat-contrast--0.50", filters.SAT_CONTRAST, map[string]any{"amount": -0.50}},
		{"sat-contrast--0.25", filters.SAT_CONTRAST, map[string]any{"amount": -0.25}},
		{"sat-contrast-0.00", filters.SAT_CONTRAST, map[string]any{"amount": 0.00}},
		{"sat-contrast-0.25", filters.SAT_CONTRAST, map[string]any{"amount": 0.25}},
		{"sat-contrast-0.50", filters.SAT_CONTRAST, map[string]any{"amount": 0.50}},
		{"sat-contrast-0.75", filters.SAT_CONTRAST, map[string]any{"amount": 0.75}},
		{"sat-contrast-1.00", filters.SAT_CONTRAST, map[string]any{"amount": 1.00}},
		{"sat-contrast-1.50", filters.SAT_CONTRAST, map[string]any{"amount": 1.50}},
		{"sat-contrast-2.00", filters.SAT_CONTRAST, map[string]any{"amount": 2.00}},

		{"lum-contrast--1.00", filters.LUM_CONTRAST, map[string]any{"amount": -1.00}},
		{"lum-contrast--0.75", filters.LUM_CONTRAST, map[string]any{"amount": -0.75}},
		{"lum-contrast--0.50", filters.LUM_CONTRAST, map[string]any{"amount": -0.50}},
		{"lum-contrast--0.25", filters.LUM_CONTRAST, map[string]any{"amount": -0.25}},
		{"lum-contrast-0.00", filters.LUM_CONTRAST, map[string]any{"amount": 0.00}},
		{"lum-contrast-0.25", filters.LUM_CONTRAST, map[string]any{"amount": 0.25}},
		{"lum-contrast-0.50", filters.LUM_CONTRAST, map[string]any{"amount": 0.50}},
		{"lum-contrast-0.75", filters.LUM_CONTRAST, map[string]any{"amount": 0.75}},
		{"lum-contrast-1.00", filters.LUM_CONTRAST, map[string]any{"amount": 1.00}},
		{"lum-contrast-1.50", filters.LUM_CONTRAST, map[string]any{"amount": 1.50}},
		{"lum-contrast-2.00", filters.LUM_CONTRAST, map[string]any{"amount": 2.00}},

		{"saturation--1.00", filters.SAT, map[string]any{"amount": -1.00}},
		{"saturation--0.75", filters.SAT, map[string]any{"amount": -0.75}},
		{"saturation--0.50", filters.SAT, map[string]any{"amount": -0.50}},
		{"saturation--0.25", filters.SAT, map[string]any{"amount": -0.25}},
		{"saturation-0.00", filters.SAT, map[string]any{"amount": 0.00}},
		{"saturation-0.25", filters.SAT, map[string]any{"amount": 0.25}},
		{"saturation-0.50", filters.SAT, map[string]any{"amount": 0.50}},
		{"saturation-0.75", filters.SAT, map[string]any{"amount": 0.75}},
		{"saturation-1.00", filters.SAT, map[string]any{"amount": 1.00}},
		{"saturation-1.50", filters.SAT, map[string]any{"amount": 1.50}},
		{"saturation-2.00", filters.SAT, map[string]any{"amount": 2.00}},
